...
- `s3://{S3_BUCKET_NAME}/manufacturing-engineering/production.env` - Production environment variables
- `s3://{S3_BUCKET_NAME}/manufacturing-engineering/sys.env` - Sys environment variables
